...
public class GridAdapterBottomHome extends BaseAdapter {
    Context context;
    ...
    public GridAdapterBottomHome(Context context, String [] huntNames) {
    ...
    public View getView(int position, View convertView,  ViewGroup parent) {
        GridAdapterBottomHome.ViewHolder viewHolder;
        final View result;
        if (convertView == null) {
            viewHolder = new GridAdapterBottomHome.ViewHolder();
            inflater = LayoutInflater.from(context);
            ...
            viewHolder = (GridAdapterBottomHome.ViewHolder) convertView.getTag();
            result=convertView;
        }
